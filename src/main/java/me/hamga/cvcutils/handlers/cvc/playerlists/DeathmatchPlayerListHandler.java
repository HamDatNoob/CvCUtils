...
import me.hamga.cvcutils.util.SortByKills;
...
public class DeathmatchPlayerListHandler {
    ...
    public void onTickEvent(TickEvent event) {
        ...
        if (HypixelUtils.INSTANCE.isHypixel() && LocrawUtil.INSTANCE.isInGame() && locraw != null && locraw.getGameType() == LocrawInfo.GameType.COPS_AND_CRIMS && Gamemodes.isDeathmatch()) {
            ...
            CvCGame.setGamemode(locraw.getGameMode());
            ...
            CvCGame.setCopsScore(Integer.parseInt(sidebar.get(7).substring(20, sidebar.get(7).indexOf("/") - 2).replaceAll(",", "")));
            CvCGame.setCrimsScore(Integer.parseInt(sidebar.get(6).substring(20, sidebar.get(6).indexOf("/") - 2).replaceAll(",", "")));
